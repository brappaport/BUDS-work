...
```{r}
# RewP
model_150275_addi_dec <- lm(AA_AR_z ~ addi_total_z + Age_c + demo_child_sex + SP_debriefing_deceived_f + site, df_150275_cz_dec)
model_150275_addi_ar_dec <- lm(AR_AA_z ~ addi_total_z + Age_c + demo_child_sex + SP_debriefing_deceived_f + site, df_150275_cz_dec)
# P300
model_275425_addi_dec <- lm(AA_AR_z ~ addi_total_z + Age_c + demo_child_sex + SP_debriefing_deceived_f + site, data = df_275425_pz_dec)
model_275425_addi_ar_dec <- lm(AR_AA_z ~ addi_total_z + Age_c + demo_child_sex + SP_debriefing_deceived_f + site, data = df_275425_pz_dec)

model_275425_addi_ar_adi_dec <- lm(AR_AA_z ~ addi_total_z + ADI_NATRANK_z + Age_c + demo_child_sex + SP_debriefing_deceived_f + site, data = df_275425_pz_dec)
```

When covarying for self-reported deception, greater self-reported discrimination distress continued to be significantly related to heightened P300~resid~ (`r  apa_print(model_275425_addi_ar_dec)$full_result$addi_total_z`) to rejection, even over-and-above SES (`r  apa_print(model_275425_addi_ar_adi_dec)$full_result$addi_total_z`).
