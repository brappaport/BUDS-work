...
```{r}
df_150275_cz_rating <- full_join(df_150275_cz, df_150275_cz_rating, by="ID")
df_275425_cz_rating <- full_join(df_275425_cz, df_275425_cz_rating, by="ID")

summary(lm(formula = AA_AR_z ~ ADI_NATRANK_z + SP_debriefing_deceived + site.x, data = df_150275_cz_rating))
summary(lm(formula = AA_AR_z ~ ADI_NATRANK_z + SP_debriefing_deceived + site.x, data = df_275425_cz_rating))
```
