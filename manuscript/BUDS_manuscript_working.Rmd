...
addi_plots_nocov <- ggarrange(scatterplot_150275_disc + 
                                ...
                                rremove("xlab") + 
                                annotate("text", x=15, y=3, label = TeX(apa_printlm(rewp_aaar_model_disc)$full_result$addi_total_z), color = "black", rot = 0, size=6)+
                                theme(axis.text.x = element_blank()),
                              scatterplot_275425_disc + 
                                ylab("P300") +
                                coord_cartesian(xlim = c(-0.5, 31), ylim=c(-3,4)) +
                                rremove("xlab") +
                                annotate("text", x=15, y=3, label = TeX(apa_printlm(p300_aaar_model_disc)$full_result$addi_total_z), color = "black", rot = 0, size=6),
    labels = c("A","B"),
    label.x = c(rep(.03,4)),
    label.y = c(rep(0.9,4)),
