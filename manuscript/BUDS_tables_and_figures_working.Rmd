...
scatterplot_275425_adi <- ggplot(df_275425_cz, aes(x=ADI_NATRANK, y=AA_AR_z)) +
  ...
  stat_smooth(method="lm", se=TRUE) +
  theme_apa() +
  labs(x="SES (percentile)", y=expression("Acceptance P300"[resid])) +
  theme()
```
...
```{r, include=TRUE, results='asis', fig.cap="Relationship between self-reported discrimination distress and brain responses to acceptance (relative to rejection) for both the RewP and P300 ERP components.", fig.width=5, fig.height=5}
