...
### 2.2.1 Alphas
```{r}
psych::alpha(BUDS_cleaning04[,c(bcs_vars[1:4])])$total$std.alpha
psych::alpha(BUDS_cleaning04[,c(bcs_vars[5:6])])$total$std.alpha
psych::alpha(BUDS_cleaning04[,c(bcs_vars[7:8])])$total$std.alpha
psych::alpha(BUDS_cleaning04[,c(bcs_vars[9:13])])$total$std.alpha
psych::alpha(BUDS_cleaning04[,c(bcs_vars[1:13])])$total$std.alpha

psych::alpha(BUDS_cleaning04[,c(bcs_vars[c(1,4)])])$total$std.alpha
psych::alpha(BUDS_cleaning04[,c(bcs_vars[c(2,3,7,8)])])$total$std.alpha
...
hist(BUDS_cleaning05$promis_peer_tscore)
hist(BUDS_cleaning05$promis_fam_tscore)
```
