...
BUDS_cleaning03_cleaned[,addi_vars] <- sapply(BUDS_cleaning03_cleaned[,addi_vars], as.numeric) # make variables of numeric class

## score
BUDS_cleaning03_cleaned$addi_total <- rowSums(BUDS_cleaning03_cleaned[,addi_vars], na.rm=TRUE)
...
BUDS_cleaning03_cleaned$addi_educ <- rowSums(BUDS_cleaning03_cleaned[,addi_vars[c(1,2,3,6)]], na.rm=TRUE)
BUDS_cleaning03_cleaned$addi_instit <- rowSums(BUDS_cleaning03_cleaned[,addi_vars[c(7,9,10,13,14)]], na.rm=TRUE)
BUDS_cleaning03_cleaned$addi_distress <- rowSums(BUDS_cleaning03_cleaned[,addi_vars[c(4,5,8,11,15)]], na.rm=TRUE)
```
### Alphas
```{r}
