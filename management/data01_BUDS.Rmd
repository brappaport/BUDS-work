...
var.labels = BUDS_cleaning02_columbia[2,]; label(BUDS_cleaning02_columbia) <- as.list(var.labels[match(names(BUDS_cleaning02_columbia), names(var.labels))])
...
BUDS_cleaning02$ID <- BUDS_cleaning02$id_1_i
