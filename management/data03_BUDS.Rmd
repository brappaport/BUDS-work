...
df_275425_cz <- merge_self_report_with_erp(data=df_275425, electrode=c("Cz"), 
...
save(df_even_50150_cz, df_even_150275_cz, df_even_275425_cz, file=here::here("./data/BUDS_split_half_even.RData"))
save(df_odd_50150_cz, df_odd_150275_cz, df_odd_275425_cz, file=here::here("./data/BUDS_split_half_odd.RData"))
