...
too_few_segments <- c(9035, 1124, 1101, 1084, 9081, 1090, 9017, 9014, 
                      1055, 9051)
bad_data <- c(1072, 9004)

subjects <- setdiff(subjects, c(too_few_segments,bad_data))
...
```{r}
too_few_segments <- c(9035, 1124, 1101, 1084, 9081, 1090, 9017, 9014, 1055, 9051)
bad_data <- c(1072, 9004)

files_artifacts  <- list.files(path=here("./data/eeg_processing_fully_auto/Scripts/Events/feedback/"), 
...
df_artifacts <- lapply(files_artifacts, read.csv, header = TRUE) %>%
  ...
  filter(!ID %in% c(too_few_segments,bad_data))
  

files_50150  <- list.files(path=here("./data/eeg_processing_fully_auto/Scripts/trial_level_data/50150/"), 
...
files_150275  <- list.files(path=here("./data/eeg_processing_fully_auto/Scripts/trial_level_data/150275/"), 
...
files_275425  <- list.files(path=here("./data/eeg_processing_fully_auto/Scripts/trial_level_data/275425/"), 
...
adi_codes <- read.csv(here("./data/ADI/national/US_2021_ADI_Census_Block_Group_v4_0_1.csv"))
...
```{r}
geocode_data_with_adi[geocode_data_with_adi$ID==1000,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1001,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1010,"ADI_NATRANK"] <- 24
geocode_data_with_adi[geocode_data_with_adi$ID==1022,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1039,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1043,"ADI_NATRANK"] <- NA # this is a small side street that looks to only exist in one tract with NATRANK of 6
geocode_data_with_adi[geocode_data_with_adi$ID==1053,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1060,"ADI_NATRANK"] <- 4
geocode_data_with_adi[geocode_data_with_adi$ID==1071,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1074,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1094,"ADI_NATRANK"] <- 8
geocode_data_with_adi[geocode_data_with_adi$ID==1099,"ADI_NATRANK"] <- 12
...
geocode_data_with_adi[geocode_data_with_adi$ID==1114,"ADI_NATRANK"] <- (9+4)/2 # Are these really the same?
geocode_data_with_adi[geocode_data_with_adi$ID==1117,"ADI_NATRANK"] <- (5+4+21)/3
geocode_data_with_adi[geocode_data_with_adi$ID==1118,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1120,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1121,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1122,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1123,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1125,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==1126,"ADI_NATRANK"] <- NA
...
geocode_data_with_adi[geocode_data_with_adi$ID==9027,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==9039,"ADI_NATRANK"] <- 28
geocode_data_with_adi[geocode_data_with_adi$ID==9044,"ADI_NATRANK"] <- (21+29)/2
geocode_data_with_adi[geocode_data_with_adi$ID==9052,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==9060,"ADI_NATRANK"] <- 57
geocode_data_with_adi[geocode_data_with_adi$ID==9069,"ADI_NATRANK"] <- 3
geocode_data_with_adi[geocode_data_with_adi$ID==9087,"ADI_NATRANK"] <- NA
geocode_data_with_adi[geocode_data_with_adi$ID==9091,"ADI_NATRANK"] <- 28
...
df_275425_cz <- left_join(df_275425_cz, geocode_data_with_adi_log, by="ID") %>%
  filter(complete.cases(AA_AR))
df_275425_cz$ADI_NATRANK_c = scale(center=TRUE, scale=FALSE, df_275425_cz$ADI_NATRANK)
df_275425_cz$ADI_NATRANK_z = scale(center=TRUE, scale=TRUE, df_275425_cz$ADI_NATRANK)
df_275425_cz$ADI_NATRANK_log_c = scale(center=TRUE, scale=FALSE, df_275425_cz$ADI_NATRANK_log)
df_275425_cz$ADI_NATRANK_log_z = scale(center=TRUE, scale=TRUE, df_275425_cz$ADI_NATRANK_log)
...
df_150275_cz$ADI_NATRANK_log_c = scale(center=TRUE, scale=FALSE, df_150275_cz$ADI_NATRANK_log)
df_150275_cz$ADI_NATRANK_log_z = scale(center=TRUE, scale=TRUE, df_150275_cz$ADI_NATRANK_log)

df_50150_cz <- left_join(df_50150_cz, geocode_data_with_adi_log, by="ID") %>%
  filter(complete.cases(AA_AR))
df_50150_cz$ADI_NATRANK_c = scale(center=TRUE, scale=FALSE, df_50150_cz$ADI_NATRANK)
df_50150_cz$ADI_NATRANK_z = scale(center=TRUE, scale=TRUE, df_50150_cz$ADI_NATRANK)
df_50150_cz$ADI_NATRANK_log_c = scale(center=TRUE, scale=FALSE, df_50150_cz$ADI_NATRANK_log)
df_50150_cz$ADI_NATRANK_log_z = scale(center=TRUE, scale=TRUE, df_50150_cz$ADI_NATRANK_log)

corr.test(df_150275_cz$AA_AR, df_275425_cz$AA_AR)
corr.test(df_150275_cz$Acc_Acc, df_275425_cz$Acc_Rej)

df_275425_cz_long <- left_join(df_275425_cz_long, geocode_data_with_adi_log, by="ID") %>%
        mutate(site = case_match(as.character(id_2_i), "CUMC" ~ "Columbia",
                                   "2" ~ "Northwestern",
                                   NA ~ NA)) %>%
  group_by(Voting, Feedback) %>%
  mutate(ADI_NATRANK_c = scale(center=TRUE, scale=FALSE, ADI_NATRANK),
         ADI_NATRANK_z = scale(center=TRUE, scale=TRUE, ADI_NATRANK),
         ADI_NATRANK_log_c = scale(center=TRUE, scale=FALSE, ADI_NATRANK_log),
         ADI_NATRANK_log_z = scale(center=TRUE, scale=TRUE, ADI_NATRANK_log))
df_150275_cz_long <- left_join(df_150275_cz_long, geocode_data_with_adi_log, by="ID") %>%
        mutate(site = case_match(as.character(id_2_i), "CUMC" ~ "Columbia",
                                   "2" ~ "Northwestern",
                                   NA ~ NA)) %>%
  group_by(Voting, Feedback) %>%
  mutate(ADI_NATRANK_c = scale(center=TRUE, scale=FALSE, ADI_NATRANK),
         ...
         ADI_NATRANK_log_c = scale(center=TRUE, scale=FALSE, ADI_NATRANK_log),
         ADI_NATRANK_log_z = scale(center=TRUE, scale=TRUE, ADI_NATRANK_log))
df_50150_cz_long <- left_join(df_50150_cz_long, geocode_data_with_adi_log, by="ID") %>%
        mutate(site = case_match(as.character(id_2_i), "CUMC" ~ "Columbia",
                                   "2" ~ "Northwestern",
                                   NA ~ NA)) %>%
  group_by(Voting, Feedback) %>%
...
#### Number missing ADI
```{r, eval=FALSE}
missing <- df_150275_cz[,c("ID","id_2_i","ADI_NATRANK")] %>%
  filter(is.na(ADI_NATRANK) | ADI_NATRANK=="GQ") %>%
  select(ID)
sum(is.na(df_150275_cz$ADI_NATRANK))
sum(!is.na(df_150275_cz$ADI_NATRANK))

address <- left_join(geocode_data2, adi_codes, by="FIPS") %>% filter(ID<8999)
address[address$ID==1001,"V2"]
```
