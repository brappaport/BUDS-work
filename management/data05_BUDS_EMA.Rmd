...
subjects_with_less_than_3_responses <- resp.rate[(resp.rate$n<3),"subject_id"]
write.csv(subjects_with_less_than_3_responses, file=here::here("./data/number_with_less_than_3_EMA_responses.csv"))
